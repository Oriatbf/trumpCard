...
namespace PlayableCharacterData
{
    ...
    { 
        ...
        static string spreadSheetID = "1XGI--3x7ZrLgtsCqT8M1o6Y1xRIKuWRq7DbnglpVNqE"; // it is file id
...
#region fuctions
        ...
        public static void Load(bool forceReload = false)
        {
            ...
            string text = reader.ReadData("PlayableCharacterData"); 
            if (text != null)
            {
